// Este archivo contiene todos los productos actuales de la tienda
module.exports = [
    {
    ...
    },
    {
      ...
      "sku": "MLC8822479",
      "marca": "Sunstars",
      "descripcionLarga": "Sunstar es el mayor proveedor de OEM y posventa de piñones para motocicletas del mundo y ha fabricado piñones para todas las principales motocicletas en Japón, Europa y Estados Unidos desde 1946. Con una línea completa de productos que incluye piñones de repuesto de acero estándar de larga duración, funciona producto de carreras de aluminio, las ruedas dentadas del contra eje PowerDrive y la exclusiva y ligera rueda dentada de acero inoxidable conocida como Works Z, Sunstar puede satisfacer todas y cada una de las necesidades de las ruedas dentadas."
    },
    {
    ...
    },
    {
      ...
      "sku": "MLC1809761350",
      "marca": "Regina",
      "descripcionLarga": "La cadena Regina ZRP Sportbike ha sido especialmente diseñada para utilizar en motos de alta potencia, gracias al sellado patentado Z-Ring. Esta cadena ha sido ensamblada con pasadores y placas de acero de alta aleación, casquillos y rodillos sólidos, granallado de placas, pasadores y rodillos y pretensado para mejorar el rendimiento, garantizando una excelente resistencia a las tensiones mecánicas de las últimas motos de superbikes."
    },
    {
